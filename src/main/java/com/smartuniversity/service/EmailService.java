...
public class EmailService {
     ...
     */
    public void sendEmailVerificationOTP(String email, String otp, String name) throws MessagingException {
        String subject = "Verify Your Email - Athena Account";
        String htmlContent = buildEmailVerificationEmail(otp, name);
        sendHtmlEmail(email, subject, htmlContent);
    }
     ...
     */
    private String buildEmailVerificationEmail(String otp, String name) {
        ...
        return """
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e4e4e4; border-radius: 8px;">
              <div style="text-align: center; margin-bottom: 20px;">
                ...
                <p style="color: #5f6368; font-size: 16px;">Email Verification</p>
              </div>
              ...
              <div style="border-top: 2px solid #f0f0f0; border-bottom: 2px solid #f0f0f0; padding: 20px 0; margin-bottom: 20px;">
                ...
                <p style="margin-bottom: 15px;">Welcome to Athena! Please verify your university email to complete your registration.</p>
                ...
                <p style="margin-bottom: 15px;">This code will <strong>expire in 1 hour</strong>.</p>
